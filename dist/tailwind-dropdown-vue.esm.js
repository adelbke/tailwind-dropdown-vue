...
const __vue_inject_styles__ = function (inject) {
  if (!inject) return;
  inject("data-v-1ff7aaf1_0", {
    source: ".dropdown-menu{@apply absolute z-10 right-0;}.dropdown-btn{@apply relative inline-block;}",
    map: undefined,
    media: undefined
  });
};
...
const install = function installTailwindDropdownVue(Vue) {
  if (install.installed) return;
  install.installed = true;
  Vue.component('TailwindDropdownVue', __vue_component__);
